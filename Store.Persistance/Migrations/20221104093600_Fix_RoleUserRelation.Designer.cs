...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20221104093600_Fix_RoleUserRelation")]
    partial class Fix_RoleUserRelation
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 11, 4, 13, 5, 59, 647, DateTimeKind.Local).AddTicks(8460),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 11, 4, 13, 5, 59, 647, DateTimeKind.Local).AddTicks(8154),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 11, 4, 13, 5, 59, 647, DateTimeKind.Local).AddTicks(8367),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 11, 4, 13, 5, 59, 647, DateTimeKind.Local).AddTicks(8406),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
