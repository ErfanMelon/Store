...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20221025082304_Order")]
    partial class Order
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 10, 25, 11, 53, 2, 953, DateTimeKind.Local).AddTicks(4322),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 10, 25, 11, 53, 2, 953, DateTimeKind.Local).AddTicks(4003),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 10, 25, 11, 53, 2, 953, DateTimeKind.Local).AddTicks(4209),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 10, 25, 11, 53, 2, 953, DateTimeKind.Local).AddTicks(4257),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
