...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20221020112248_RequestPay")]
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 10, 20, 14, 52, 46, 960, DateTimeKind.Local).AddTicks(5816),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 10, 20, 14, 52, 46, 960, DateTimeKind.Local).AddTicks(5478),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 10, 20, 14, 52, 46, 960, DateTimeKind.Local).AddTicks(5690),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 10, 20, 14, 52, 46, 960, DateTimeKind.Local).AddTicks(5752),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
