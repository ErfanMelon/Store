...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20221027110645_UserAddress")]
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 10, 27, 14, 36, 43, 934, DateTimeKind.Local).AddTicks(1277),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 10, 27, 14, 36, 43, 934, DateTimeKind.Local).AddTicks(621),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 10, 27, 14, 36, 43, 934, DateTimeKind.Local).AddTicks(906),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 10, 27, 14, 36, 43, 934, DateTimeKind.Local).AddTicks(998),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
