...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20220916115202_fix_duplicate_Email")]
    partial class fix_duplicate_Email
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 9, 16, 16, 22, 1, 929, DateTimeKind.Local).AddTicks(6538),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 9, 16, 16, 22, 1, 929, DateTimeKind.Local).AddTicks(6728),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 9, 16, 16, 22, 1, 929, DateTimeKind.Local).AddTicks(6769),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
