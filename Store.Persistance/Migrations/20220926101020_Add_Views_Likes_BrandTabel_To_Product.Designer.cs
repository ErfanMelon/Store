...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20220926101020_Add_Views_Likes_BrandTabel_To_Product")]
    partial class Add_Views_Likes_BrandTabel_To_Product
    {
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 9, 26, 13, 40, 18, 955, DateTimeKind.Local).AddTicks(411),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 9, 26, 13, 40, 18, 955, DateTimeKind.Local).AddTicks(130),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 9, 26, 13, 40, 18, 955, DateTimeKind.Local).AddTicks(320),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 9, 26, 13, 40, 18, 955, DateTimeKind.Local).AddTicks(361),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
