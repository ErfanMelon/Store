...
namespace Store.Persistance.Migrations
{
    ...
    [Migration("20221013142649_Add_Cart")]
            ...
            modelBuilder.Entity("Store.Domain.Entities.Products.ProductBrand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BrandId = 1,
                            Brand = "متفرقه",
                            InsertTime = new DateTime(2022, 10, 13, 17, 56, 48, 286, DateTimeKind.Local).AddTicks(1235),
                            IsRemoved = false
                        });
                });
            ...
            modelBuilder.Entity("Store.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            InsertTime = new DateTime(2022, 10, 13, 17, 56, 48, 286, DateTimeKind.Local).AddTicks(886),
                            IsRemoved = false,
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            InsertTime = new DateTime(2022, 10, 13, 17, 56, 48, 286, DateTimeKind.Local).AddTicks(1118),
                            IsRemoved = false,
                            RoleName = "Operator"
                        },
                        new
                        {
                            RoleId = 3,
                            InsertTime = new DateTime(2022, 10, 13, 17, 56, 48, 286, DateTimeKind.Local).AddTicks(1175),
                            IsRemoved = false,
                            RoleName = "Customer"
                        });
                });
